...
class test_add_contact(unittest.TestCase):
    ...
    def test_test_add_contact(self):
        ...
        self.create_contact(wd, Contact(firstname="wojtek", middlename="marek", lastname="wojtasik", nickname="nico", title="newone", company="qa", address="Poland", home="-", mobile="-", work="-", fax="-",
                            email="test@test.pl", email3="-", email2="-", homepage="-", byear="1980", ayear="1990", address2="Poland, lodz"))
        self.logout(wd)
